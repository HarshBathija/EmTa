...
|Number of commits|3|[Commits](https://github.com/HarshBathija/Employee-Meal-Tracking-Assistant/commits/master)|
|Number of commits: by different people|3|[Contributors Commits Graph](https://github.com/HarshBathija/Employee-Meal-Tracking-Assistant/graphs/contributors)|
|Issues reports: there are many|2|[Issues Report](https://github.com/HarshBathija/Employee-Meal-Tracking-Assistant/issues?q=is%3Aissue+is%3Aclosed)|
|issues are being closed|3|[Closed Issues](https://github.com/HarshBathija/Employee-Meal-Tracking-Assistant/issues?q=is%3Aissue+is%3Aclosed)|
|DOI badge: exists|3|[ReadMe](https://github.com/HarshBathija/Employee-Meal-Tracking-Assistant/blob/master/README.md)|
...
|Use of code coverage|2|We have used jacoco library for our project code coverage as configured in the [build.gradle](https://github.com/HarshBathija/EmTa/blob/master/build.gradle) and the link to the report will be found [here](https://github.com/HarshBathija/EmTa/tree/master/docs/reports/jacoco/test/html)|
...
|evidence that the whole team is using the same tools: everyone can get to all tools and files|3| We are using gradle wrapper and spring boot framework|
|evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)|3| [Commits](https://github.com/HarshBathija/Employee-Meal-Tracking-Assistant/commits/master)|
...
| Question 15.7: Do you have a recommended citation for your software? * | 3 | Yes , [Citation.MD](https://github.com/HarshBathija/Employee-Meal-Tracking-Assistant/blob/master/CITATION.md) |
